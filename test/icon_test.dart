...
void main() {
  ...
  testWidgets('Icon sizing - no theme, default size', (
    ...
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child: Center(child: Icon(Codicons.add)),
      ),
    );
  ...
  testWidgets('Icon sizing - no theme, explicit size', (
    ...
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child: Center(child: Icon(Codicons.add, size: 96)),
      ),
    );
  ...
  testWidgets('Icon sizing - sizeless theme, default size', (
    ...
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child: Center(
          child: IconTheme(data: IconThemeData(), child: Icon(Codicons.add)),
        ),
      ),
    );
  ...
  testWidgets("Changing semantic label from null doesn't rebuild tree ", (
    ...
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
        child: Center(child: Icon(Codicons.add, semanticLabel: 'a label')),
      ),
    );
